...
<input class="font3" type="hidden" name="idx" value="${ dto.idx }"/>
<input class="font3" type="hidden" name="prevOfile" value="${ dto.ofile }" />
<input class="font3" type="hidden" name="prevSfile" value="${ dto.sfile }" />
...
<table class="table table-hover font3" width="90%">
    ...
    <tr>
        <td>내용</td>
        <td align="left">
            <textarea name="content" style="width:90%;height:300px;">${ dto.content }</textarea>
        </td>
    </tr>
    <tr>
        <td>첨부 파일</td>
